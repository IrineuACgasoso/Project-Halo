...
class Escharum(BaseEnemy, TartarusSetup, TartarusAI, TartarusAttacks):
    """Classe principal do Boss Escharum"""
    def __init__(self, posicao, game, ativar_halo=True, **kwargs):
        super().__init__(posicao, vida_base=4000, dano_base=60, velocidade_base=120, 
                         game=game, sprite_key='escharum')
        
        self.titulo = "ESCHARUM, Lorde da Guerra"
        self.is_boss = True 
